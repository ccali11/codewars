...
class User {
  constructor() {
    this.rank = -8;
    this.currentIndex = 0;
    this.possibleRanks = [-8, -7, -6, -5, -4, -3, -2, -1, 1, 2, 3, 4, 5, 6, 7, 8];
    this.progress = 0;
  }
  ...
  incProgress(activityRank) {
    ...
    if (this.rank === 8) {
      ...
      if (this.progress >= 100) {
        this.currentIndex++;
        this.rank = this.possibleRanks[this.currentIndex];
      ...
      let progressionPoints = 10 * d * d;
      this.progress += progressionPoints;
      if (this.progress >= 100) {
        this.currentIndex++;
        this.rank = this.possibleRanks[this.currentIndex];
        this.progress = this.progress - 100;
